...
const grafo = new Grafo<string>(estados);

// Fronteiras reais entre os estados
grafo.adicionarArestaUsandoVertices("Rio Grande do Sul", "Santa Catarina");

grafo.adicionarArestaUsandoVertices("Santa Catarina", "Paraná");

grafo.adicionarArestaUsandoVertices("Paraná", "São Paulo");

grafo.adicionarArestaUsandoVertices("São Paulo", "Mato Grosso do Sul");
grafo.adicionarArestaUsandoVertices("São Paulo", "Goiás");
grafo.adicionarArestaUsandoVertices("São Paulo", "Minas Gerais");

grafo.adicionarArestaUsandoVertices("Rio de Janeiro", "Minas Gerais");
grafo.adicionarArestaUsandoVertices("Rio de Janeiro", "Espírito Santo");

grafo.adicionarArestaUsandoVertices("Espírito Santo", "Minas Gerais");

grafo.adicionarArestaUsandoVertices("Minas Gerais", "Mato Grosso do Sul");
grafo.adicionarArestaUsandoVertices("Minas Gerais", "Goiás");

grafo.adicionarArestaUsandoVertices("Goiás", "Mato Grosso do Sul");
grafo.adicionarArestaUsandoVertices("Goiás", "Mato Grosso");

grafo.adicionarArestaUsandoVertices("Mato Grosso", "Mato Grosso do Sul");
